**_В этом репозитории собран проект, над которым я работаю,
пока ищу работу на позицию Java-разработчика. Тут каждый день заливаю новую фичу.
...
* Spring Cloud Eureka Server - Для обнаружения и регистрации сервисов
