...
public class LoansDTO {
    ...
    @Pattern(regexp= AccountHelper.TEN_DIGITS_PATTERN, message = "Mobile Number must be 10 digits")
    @Schema(
    ...
    @Pattern(regexp= AccountHelper.TWELVE_DIGITS_PATTERN, message = "LoanNumber must be 12 digits")
    @Schema(
